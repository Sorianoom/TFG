"""
Script: extract_background_50_50.py

Descripción:
Extrae una muestra exacta de tráfico normal (background) a partir del dataset limpio,
con el objetivo de construir un dataset balanceado con proporción 50% tráfico normal
...
Uso:
python scripts/balancing/extract_background_50_50.py
...
OUTPUT_FILE = Path("data/clean/balanced_50_50/background_sample_50_50.csv")

TARGET_BACKGROUND = 1_985_304
