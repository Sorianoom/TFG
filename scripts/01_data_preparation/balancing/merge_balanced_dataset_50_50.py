"""
Script: merge_balanced_dataset_50_50.py

Descripción:
Combina el tráfico malicioso y la muestra de tráfico normal
para generar un dataset final con proporción 50% tráfico normal
y 50% tráfico malicioso.

Entrada:
- data/clean/base/malicious_only.csv
- data/clean/balanced_50_50/background_sample_50_50.csv

Salida:
- data/clean/balanced_50_50/balanced_dataset_50_50.csv

Uso:
python scripts/balancing/merge_balanced_dataset_50_50.py

Notas:
- Procesamiento secuencial (no carga los archivos completos en memoria)
- Mantiene la estructura original de las filas
- Se utiliza para construir el dataset final del escenario 50/50
"""
...
BACKGROUND_FILE = Path("data/clean/balanced_50_50/background_sample_50_50.csv")
OUTPUT_FILE = Path("data/clean/balanced_50_50/balanced_dataset_50_50.csv")
