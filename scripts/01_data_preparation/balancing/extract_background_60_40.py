"""
Script: extract_background_60_40.py

Descripción:
Extrae una muestra exacta de tráfico normal (background) a partir del dataset limpio,
con el objetivo de construir un dataset balanceado con proporción 60% tráfico normal
...
Uso:
python scripts/balancing/extract_background_60_40.py
...
OUTPUT_FILE = Path("data/clean/balanced_60_40/background_sample_60_40.csv")

TARGET_BACKGROUND = 2_977_956
