"""
Script: merge_balanced_dataset_60_40.py

Descripción:
Combina el tráfico malicioso y la muestra de tráfico normal
para generar un dataset final con proporción 60% tráfico normal
y 40% tráfico malicioso.

Entrada:
- data/clean/base/malicious_only.csv
- data/clean/balanced_60_40/background_sample_60_40.csv

Salida:
- data/clean/balanced_60_40/balanced_dataset_60_40.csv

Uso:
python scripts/balancing/merge_balanced_dataset_60_40.py

Notas:
- Procesamiento secuencial (no carga los archivos completos en memoria)
- Mantiene la estructura original de las filas
- Se utiliza como dataset base para el análisis principal
"""
...
BACKGROUND_FILE = Path("data/clean/balanced_60_40/background_sample_60_40.csv")
OUTPUT_FILE = Path("data/clean/balanced_60_40/balanced_dataset_60_40.csv")
