"""
Script: count_labels_50_50.py

Descripción:
Calcula la distribución de etiquetas del dataset balanceado 50/50,
...
Uso:
python scripts/balancing/count_labels_50_50.py
...
INPUT_FILE = Path("data/clean/balanced_50_50/balanced_dataset_50_50.csv")
