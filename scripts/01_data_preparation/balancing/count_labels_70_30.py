"""
Script: count_labels_70_30.py

Descripción:
Calcula la distribución de etiquetas del dataset balanceado 70/30,
...
Uso:
python scripts/balancing/count_labels_70_30.py
...
INPUT_FILE = Path("data/clean/balanced_70_30/balanced_dataset_70_30.csv")
