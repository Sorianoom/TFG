\chapter{Diseño de una plataforma web interactiva}
\label{cap:web}
...
\caption{Pantalla principal de la aplicación web, desde la que se accede a las familias de ataque y a las principales funciones del sistema. Captura propia de la aplicación web.}
...
\caption{Pantalla de detalle de una familia de ataque en la aplicación web. Captura propia de la aplicación web.}
...
\caption{Señales conductuales mostradas por la web para explicar la decisión del detector. Captura propia de la aplicación web.}
...
En el modo IA OFF, el simulador usa plantillas locales sencillas de la propia web. No se emplea ningún mecanismo de generación reproducible por semilla. La validación real del detector se hizo siempre con UGR'16, no con estas ventanas. La Figura~\ref{fig:web_simulador} muestra el simulador en funcionamiento.

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\textwidth]{imagenes/web_simulador.png}
\caption{Simulador de ventanas sintéticas utilizado para ilustrar patrones de ataque. Captura propia de la aplicación web.}
...
\caption{Ejecución del clasificador contextual desde la aplicación web sobre un CSV pequeño de ejemplo. Captura propia de la aplicación web.}
