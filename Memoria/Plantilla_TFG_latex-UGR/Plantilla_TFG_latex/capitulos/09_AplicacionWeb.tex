...
La web permite probar el clasificador sin tocar los scripts. El usuario sube una ventana en formato CSV (con un límite de tamaño pequeño, de unos pocos megabytes), la web comprueba que tenga las columnas esperadas y la envía al backend, que ejecuta el clasificador sobre cada traza. La respuesta incluye, por traza, la decisión (ataque o normal), la familia, el subtipo, un nivel de confianza y la señal que ha justificado la decisión, junto con un resumen del conjunto.
