...
\begin{itemize}
  ...
  \item Integrar \textbf{capturas y figuras definitivas} en la web y en la memoria, donde ahora hay marcadores pendientes.
  ...
  \item Añadir más \textbf{visualizaciones y trazabilidad} para el análisis de errores.
