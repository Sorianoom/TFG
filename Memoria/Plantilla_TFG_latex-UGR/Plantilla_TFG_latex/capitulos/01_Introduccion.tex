...
\begin{itemize}
  ...
  \item \textbf{Bibliografía.} Recoge las referencias utilizadas a lo largo de la memoria.
  \item \textbf{Apéndices.} Incluyen material complementario: manual de uso de la web, guía para lanzarla, tablas completas de resultados, pseudocódigo extendido, ejemplos de ventanas sintéticas y la declaración de uso de herramientas de inteligencia artificial.
\end{itemize}
