...
El proyecto se planificó desde un inicio en las siguientes fases:
...
En cuanto al hardware, se ha utilizado un equipo personal. Su coste se imputa únicamente como \textbf{amortización} correspondiente al periodo de uso del proyecto. La Tabla~\ref{tab:coste_material} recoge esta estimación.
